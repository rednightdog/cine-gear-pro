...
export function CineBrainChat() {
    ...
    const { theme } = useTheme(); // Use theme context if needed for specific coloring
    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 ${isOpen ? 'rotate-90 bg-destructive text-white' : 'bg-primary text-primary-foreground'
                    }`}
            >
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-24 right-6 w-96 h-[500px] z-50 bg-background/95 backdrop-blur-md border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-10 fade-in duration-300">
                    {/* Header */}
                    ...
                    <div className="p-4 bg-background border-t border-border">
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 bg-secondary/50 border-none rounded-xl px-4 py-2 focus:ring-2 focus:ring-primary/50 outline-none text-sm"
                            />
                            <button
                                onClick={handleSend}
